      ...
      <div class="bs-docs-section">
        <div class="page-header">
          <div class="row">
            <div class="col-lg-12" align="center">
              <h3 id="buttons"> Download the zip file that generates your CSR and Private Key:
              <h4>Extract the files and run the Batch file generated on your name</h4></h3>
            </div>
          </div>
        </div>
		</div>
        ...
        <div class="well">
            ...
            <form class="form-horizontal" action="download.php" method="post">
             ...
             <div class="well">
             <center>
                <a href="user_after_login.php"><button type="button" class="btn btn-primary">Back</button></a>
